...
The only difference is time doesn't add, but subtract. The length is the dot product of a vector with itself. We will look at one more important vector later.
}
...
\draw (0,0.5) node[anchor=west,blue] {$ds^2 = -c^2 d\tau^2$};
...
\draw (0.3,0.5) node[anchor=west,blue] {$ds^2 = -c^2 dt^2 + dx^2$};
